...
const (
	...
	UserData_UserInfo_FullMethodName          = "/sso.UserData/UserInfo"
...
func (c *userDataClient) UserInfo(ctx context.Context, in *UserInfoRequest, opts ...grpc.CallOption) (*UserInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserInfoResponse)
	err := c.cc.Invoke(ctx, UserData_UserInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserDataServer) UserInfo(context.Context, *UserInfoRequest) (*UserInfoResponse, error) {
...
func _UserData_UserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserDataServer).UserInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserData_UserInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserDataServer).UserInfo(ctx, req.(*UserInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserData_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UserInfo",
			Handler:    _UserData_UserInfo_Handler,
		},
		{
...
const (
	...
	AppManagement_AppData_FullMethodName     = "/sso.AppManagement/AppData"
)
...
type AppManagementClient interface {
	...
	AppData(ctx context.Context, in *AppDataRequest, opts ...grpc.CallOption) (*AppDataResponse, error)
}
...
func (c *appManagementClient) AppData(ctx context.Context, in *AppDataRequest, opts ...grpc.CallOption) (*AppDataResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AppDataResponse)
	err := c.cc.Invoke(ctx, AppManagement_AppData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AppManagementServer interface {
	...
	AppData(context.Context, *AppDataRequest) (*AppDataResponse, error)
...
func (UnimplementedAppManagementServer) AppData(context.Context, *AppDataRequest) (*AppDataResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method AppData not implemented")
}
...
func _AppManagement_AppData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AppDataRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppManagementServer).AppData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AppManagement_AppData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppManagementServer).AppData(ctx, req.(*AppDataRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AppManagement_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "AppData",
			Handler:    _AppManagement_AppData_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "sso/sso.proto",
...
const (
	PermissionsManagement_UserRoles_FullMethodName       = "/sso.PermissionsManagement/UserRoles"
...
func (c *permissionsManagementClient) UserRoles(ctx context.Context, in *UserRolesRequest, opts ...grpc.CallOption) (*UserRolesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UserRolesResponse)
	err := c.cc.Invoke(ctx, PermissionsManagement_UserRoles_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPermissionsManagementServer) UserRoles(context.Context, *UserRolesRequest) (*UserRolesResponse, error) {
...
func _PermissionsManagement_UserRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UserRolesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PermissionsManagementServer).UserRoles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PermissionsManagement_UserRoles_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PermissionsManagementServer).UserRoles(ctx, req.(*UserRolesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _PermissionsManagement_UserRoles_Handler,
		},
		{
